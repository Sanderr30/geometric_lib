...
class TestCalculate(unittest.TestCase):
    ...
    def test_invalid_figure(self):
        ...
        self.assertEqual(
            str(context.exception),
            "Figure'tetrahedron' is not available. Available figures: ['circle', 'square', 'triangle']"
        )
    ...
    def test_incorrect_parameter_count_circle(self):
        ...
        self.assertIn(
            "For the figure 'circle' 1  parameters are required , but was provided 2",
            str(context.exception)
        )
    ...
    def test_incorrect_parameter_count_triangle(self):
        ...
        self.assertIn(
            "For the figure 'triangle' 3  parameters are required , but was provided 2",
            str(context.exception)
        )
...
class TestCalculate(unittest.TestCase):
    ...
    def test_negative_size_circle(self):
        with self.assertRaises(ValueError) as context:
            calc('circle', 'area', [-5])
        self.assertIn("Radius of square must be positive.",
                      str(context.exception))
